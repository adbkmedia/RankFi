  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 py-10 md:py-12 relative z-10">
        ...
        {/* Description */}
        <p className="text-base md:text-lg text-white text-center max-w-3xl mx-auto mb-6 leading-relaxed">
        ...
        <div className="flex flex-wrap justify-center gap-2">
          {filterButtons.map((button, idx) => (
            <button
              key={idx}
              className="bg-white text-gray-800 px-4 py-2 rounded-full text-xs md:text-sm font-medium hover:bg-gray-50 transition-colors flex items-center gap-2 shadow-sm"
            >
              {button.icon}
